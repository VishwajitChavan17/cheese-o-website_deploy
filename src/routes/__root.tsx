  ...
  head: () => ({
    meta: [
      ...
      { title: "Cheese\u201cO\u201d — Artisanal Cheese, Crafted Slowly" },
      {
        name: "description",
        content:
          "Cheese\u201cO\u201d is an artisanal cheese maker. Small-batch wheels, cold-chain delivery across India.",
      },
      { property: "og:site_name", content: "Cheese\u201cO\u201d" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: 'Cheese"O"',
          slogan: "Crafted slowly. Savoured completely.",
        }),
      },
    ],
  }),
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <CartProvider>
        <Navbar />
        <main id="main" className="page-enter pt-20">
